    ...
    <section className="w-full py-5">
      ...
      <div className="my-20 flex flex-col lg:flex-row items-center justify-center w-full gap-4">
        ...
        <Card
          ...
          des="Setting clear goals, defining requirements, and mapping out the roadmap."
        >
          <CanvasRevealEffect
            animationSpeed={5.1}
        ...
        <Card
          ...
          des="Building scalable, maintainable, and optimized solutions."
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-zinc-900 rounded-3xl overflow-hidden"
        ...
        <Card
          ...
          des="Ensuring stability, updates, and continuous improvement."
        >
          <CanvasRevealEffect
            animationSpeed={3}
            containerClassName="bg-zinc-900 rounded-3xl overflow-hidden"
