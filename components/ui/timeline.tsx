  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-lg md:text-4xl mb-3 text-black dark:text-white max-w-4xl">
          My Projects & Creations
        </h2>

        <p className="text-neutral-700 dark:text-neutral-300 text-sm md:text-base max-w-sm">
          Here’s a curated timeline of the projects I’ve built, showcasing my
          expertise in full-stack development, modern frameworks, and creative
          problem-solving.
        </p>
      </div>
